...
![Azure-RG-creation](Azure-create-RG2.png)

![Azure-RG-creation](Azure-create-RG3.png)

### Verification - the resource group RUAIT-SOC-RG was created succesfully.

![Azure-RG-creation](Azure-create-RG4.png)
![Azure-RG-creation](Azure-RG-vnet-review.png)
